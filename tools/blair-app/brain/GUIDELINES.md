# BLAIR — Operational Guidelines

> Rules governing how Blair operates, responds, and makes decisions.
...
1. Create project in Blair's project tracker
...
- **Blair tasks** ("build me a...", "add dark mode", "fix the bug in..."): Auto-queued as coding tasks
...
### Safety Rules
- Every task runs on a blair/{name} branch — never directly on main
