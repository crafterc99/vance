...
const BLAIR_HEADER = '<!-- blair-managed -->';
...
function generateSettings(projectDir) {
  ...
  if (fs.existsSync(settingsFile)) {
    try {
      ...
      if (existing._blairManaged !== true) {
  ...
  const settings = { _blairManaged: true, ...FULL_PERMISSIONS };
