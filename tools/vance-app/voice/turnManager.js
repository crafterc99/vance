/**
 * VANCE — Conversational Turn Manager
 *
 ...
 *
 * This makes Vance feel like a natural conversation partner, not a
...
const DISMISSAL_PHRASES = [
  ...
  /^(thanks|thank\s*you|thanks\s*vance|thank\s*you\s*vance)\.?$/i,
...
// Thinking fillers that Vance speaks while the LLM is processing
